...
float C111::getPSU1Current() {
  if (digitalRead(C111_ESP_HIGHSIDESWITCH_DIAGNOSTICS_SELECT_1) != LOW
...
uint8_t C111::getUserInputState(uint8_t input) {
  switch (input) {
    case C111_USER_INPUT_1:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_1);
    case C111_USER_INPUT_2:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_2);
    case C111_USER_INPUT_3:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_3);
    case C111_USER_INPUT_4:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_4);
    case C111_USER_INPUT_5:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_5);
    case C111_USER_INPUT_6:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_6);
    case C111_USER_INPUT_7:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_7);
    case C111_USER_INPUT_8:
      return ioExpander.read1(C111_IO_EXPANDER_INPUT_8);
    default:
      return false;
  }
}
